...
public class Log {
    ...
    /** Performs additional initialization, like adapting j.u.l to the logging framework of choice, etc. */
    ...
    public static void d(final String msg, final Throwable throwable) { slf4j(null).debug(msg, throwable); }

    public static void d(final String fmt, final Object... args) { slf4j(null).debug(fmt, args); }

    public static void d(final Throwable throwable) { slf4j(null).debug("", throwable); }
    ...
    public static void i(final String msg, final Throwable throwable) { slf4j(null).info(msg, throwable); }

    public static void i(final String fmt, final Object... args) { slf4j(null).info(fmt, args); }

    public static void i(final Throwable throwable) { slf4j(null).info("", throwable); }
    ...
    public static void w(final String msg, final Throwable throwable) { slf4j(null).warn(msg, throwable); }

    public static void w(final String fmt, final Object... args) { slf4j(null).warn(fmt, args); }

    public static void w(final Throwable throwable) { slf4j(null).warn("", throwable); }
    ...
    public static void e(final String msg, final Throwable throwable) { slf4j(null).error(msg, throwable); }

    public static void e(final String fmt, final Object... args) { slf4j(null).error(fmt, args); }

    public static void e(final Throwable throwable) { slf4j(null).error("", throwable); }
